...
<?php $qunatity=0; ?>                
                ...
                @endforeach
               <a class="cart-icon" onclick="getmodal();"  href="#"><img src="{{asset('').'public/images/cart_icon.png'}}" alt="photo icon">
        ...
        <div class="cart-box">
            <div class="cart-img">              
                ...
                <img src="{{asset('public/images/close_icon.png')}}" alt="cart icon"></a>
