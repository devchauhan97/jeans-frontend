...
<input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                                        ...
                                        @if(count($result['detail']['product_data'][0]->attributes)>0)
                                            ...
                                            <div class="form-row">                                    
                                                ...
                                                <div class="form-group col-sm-4">							
                                                    ...
                                                    <div class="col-sm-12">								
                                                        <select name="{{ $attributes_data['option']['id'] }}"  class="form-control {{ $attributes_data['option']['name'] }} change_price">
                                                        @foreach( $attributes_data['values'] as $values_data )
                                                            <option value="{{ $values_data['id'] }}" prefix = '{{ $values_data['price_prefix'] }}'  value_price ="{{ $values_data['price']+0 }}" @if(count($result['cart'][0]->attributes)>0) @if($result['cart'][0]->attributes[$key]->options_values_id==$values_data['id']) selected @endif @endif>{{ $values_data['value'] }}</option>											
                                                        @endforeach								
                                                        </select>								
                                                    </div>							
                                                </div>							
                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty">	
                                                ...
                                                <label for="quantity" class="col-sm-3 col-form-label">@lang('website.Quantity') </label>						
                                                <div class="input-group">						
                                                    <span class="input-group-btn first qtyminus">						
                                                    	<button class="btn btn-defualt " type="button">-</button>						
                                                    </span>						
                                                    <input type="text" readonly name="quantity" value="{{$result['cart'][0]->customers_basket_quantity}}" class="form-control qty">						
                                            ...
                                            <div class="price-box">
                                                ...
                                                <span class="total_price">
                                                    {{$web_setting[19]->value}}{{$result['cart'][0]->customers_basket_quantity*$result['cart'][0]->final_price}}
                                                </span>				
                                            </div>                                
                                            <div class="buttons">
                                                @if($result['detail']['product_data'][0]->products_quantity == 0)
                                                ...
                                                @else
                                                    <button class="btn btn-secondary btn-round update-single-Cart" type="button" products_id="{{$result['detail']['product_data'][0]->products_id}}">@lang('website.Update')</button>
                                                @endif 
                                            </div>					
                                    	</div>	
									</form>
