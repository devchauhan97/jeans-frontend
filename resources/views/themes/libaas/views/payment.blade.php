...
<section class="site-content ptb-70">
    <div class="container">
        
        <div class="row">
            <div class="clearfix"></div>
            <br>
            <div class="col-sm-10 col-md-6 col-md-offset-3 col-sm-offset-1">
                <?php
                    $price=0;
            ...
            @endif
                ...
                <div class="containerone">
                    <div class="header" id="headerp"><img src=" @if(count( $result['data_key'] )) {{ asset('public/img/plus.png') }} @else {{ asset('public/img/minus.png') }} @endif"> Use Another Card</div>
        ...
        $content.slideToggle(500, function () {       
            $header.text(function () {  
                if($content.is(":visible")==true){
                    ...
                    jQuery(this).html('<img src="{{ asset('public/img/minus.png') }}" /> Use Another Card');
                }else{
                    jQuery(this).html('<img src="{{ asset('public/img/plus.png') }}" /> Use Another Card');
                }
            });
        });
    });
