								...
								<div class="col-sm-12">
									<div class="login-form">
										<form name="signup_in_desktop" enctype="multipart/form-data" class="sign-up form-validate"  id="signup_in_desktop" action="{{ URL::to('/customer/signup')}}" method="post" >
											...
											<div class="row">
												<div class="col-sm-6">
													<input type="text" placeholder="First name:" name="first_name" id="first_name" class="form-control form-validate" value="{{ old('first_name') }}" >
													<spam class="help-block error-content" hidden>@lang('website.Please enter your first name')</spam> 
													<small class="text-danger">{{ $errors->first('first_name') }}</small>
												</div>
												<div class="col-sm-6">
													<input type="text" placeholder="Last name:" name="last_name" id="last_name" class="form-control form-validate"  value="{{ old('last_name') }}">
													<spam class="help-block error-content" hidden>@lang('website.Please enter your last name')</spam> 
													<small class="text-danger">{{ $errors->first('last_name') }}</small>
												</div>
												<div class="col-sm-12">
													<input   type="email" placeholder="Email address:" name="email" id="email" class="mb-0 form-control" value="{{ old('email') }}">
												...
												<div class="col-sm-12">
													<input class="" type="text" placeholder="Mobile No:" name="mobile_no" id="mobile_no" class="mb-0 form-control" value="{{ old('mobile_no') }}">
												...
												<div class="col-sm-6">
													<input type="text" placeholder="City:" name="city" id="city" class="mb-0 form-control" value="{{ old('city') }}">
												...
												<div class="col-sm-6">
	                                                ...
	                                                <spam class="help-block error-content" hidden>@lang('website.Please select country')</spa
												</div>
											</div>
											...
											<input type="password" placeholder="Confrim Password"  name="re_password" id="re_password">
