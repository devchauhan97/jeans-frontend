                ...
                <div class="row">
                    ...
                    <div class="product product-2x">
                        ...
                        <article>
                            ...
                            <div class="buttons">
                            	<a href="#" class="btn btn-secondary">@lang('website.Add to Cart')</a>
    	...
    	<div class="row">
        	<div class="col-xs-12 col-md-12">
            	<div class="banner-image en">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="{{asset('').'images/sale_banners_en.jpg'}}" alt="Banner Image"></a>
                </div>
                <div class="banner-image ar">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="{{asset('').'images/sale_banners_ar.jpg'}}" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="container">
                    ...
                    <div class="products products-5x">
                        ...
                        <div class="product">
                          <article>
                            ...
                            {{$web_setting[19]->value}}{{$special->products_price+0}}<span>{{$web_setting[19]->value}}{{$special->discount_price+0}}</span></div>
                            <div class="product-hover">
                                <div class="icons">
                                    <div class="icon-liked">
    ...
    <div class="group-banners">
    	<div class="row">
        	<div class="col-xs-12 col-sm-12">
            	<div class="banner-image en">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="{{asset('').'images/large_banner_en.jpg'}}" alt="Banner Image"></a>
                </div>
                <div class="banner-image ar">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="{{asset('').'images/large_banner_ar.jpg'}}" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
