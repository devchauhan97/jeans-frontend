...
class StripeController extends DataController
{
    ...
    public function postPaymentWithStripe(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'card_no' 			=> 'required|numeric|max:14',
        ...
        if ( $validator->passes() ) { 
            ...
            $stripe = Stripe::make('sk_test_Gsz7jL4wRikI8YFaNzbwxKOF');
            ...
            try {
                ...
                if($charge['status'] == 'succeeded') {
                    ...
                    */
					...
					$this->payment_status($order_information);
    ...
    public function payment_status($order_information)
    {
